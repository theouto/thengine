...
class TheDevice {
 public:
  ...
  TheDevice(TheWindow &window);
  ~TheDevice();

  // Not copyable or movable
  TheDevice(const TheDevice &) = delete;
  TheDevice &operator=(const TheDevice &) = delete;
  TheDevice(TheDevice &&) = delete;
  TheDevice &operator=(TheDevice &&) = delete;
  ...
  void imageProperty(VkFormat imageFormat, VkFormatProperties& properties)
  {
